...
def pred(input_resume):
    ...
    probabilities = svc_model.decision_function(vectorized_text)
...
def main():
    ...
    st.markdown("Upload a resume in PDF, TXT, or DOCX format and get the top 3 job categories with confidence scores.")
    ...
    if uploaded_file is not None:
        try:
            ...
            for category, confidence in top3_predictions:
